...
namespace Bookmarks.Mongo.Data
{
    public class BookmarksContext : IBookmarksContext 
    {
                                            ...
                                            (Bookmarks.Common.TagBundle tagBundle, int bufferSize)
        {
            ...
            IEnumerable<string> excludedTags = ExtractExcludeTags(tagBundle.ExcludeTagBundles ?? new string[0], tagBundle);
        ...
        public void UpdateTagBundleById(Bookmarks.Common.TagBundle tagBundle)
        {
            ...
            var update = Builders<Bookmarks.Mongo.Data.TagBundle>.Update
                .Set(t => t.ExcludeTagBundles, tagBundle.ExcludeTagBundles)
                .Set(t => t.Tags, tagBundle.Tags)
                .Set(t => t.ExcludeTags, tagBundle.ExcludeTags)                
                .CurrentDate("lastModified");
        ...
        public IEnumerable<Bookmarks.Common.TagCount> GetNextMostFrequentTags(string tagBundleId
                                                                            , string[] excludeTagBundles
                                                                            , int limitTermCounts = TAG_COUNTS_PAGE_SIZE)
        {
            ...
            tagBundle.ExcludeTags = tagBundle.ExcludeTags.Except(excludedTags).ToArray();
        ...
        public void UpdateBookmarkCollectionId(string tagBundleId, string bookmarksCollectionId)
        {
            ...
            var filter = builder.Eq(t => t.Id, tagBundleId);
            var update = Builders<Bookmarks.Mongo.Data.TagBundle>.Update
                .AddToSet(t => t.BookmarksCollections, bookmarksCollectionId)
                .CurrentDate("lastModified");
        ...
        public IEnumerable<Bookmarks.Common.TagBundle> GetTagBundleNames(string bookmarksCollectionId)
        {
            ...
            {
                var bookmarkCollectionFilter = new BsonDocument
                                    {
                                        {
                ...
                query = tagBundles.Find<Bookmarks.Mongo.Data.TagBundle>(bookmarkCollectionFilter);
            }
            ...
            return result.Select(t=>
                new Bookmarks.Common.TagBundle
                    ...
                    , Name = t.GetValue("Name").AsString}).ToList();
        }
        ...
        public void UpdateExcludeTagBundlesList(string tagBundleId, string[] excludeTagBundles)
        {
            var tagBundles = _database.GetCollection
                   <Bookmarks.Mongo.Data.TagBundle>(TAG_BUNDLES_COLLECTION);
            ...
            var filter = builder.Eq(t => t.Id, tagBundleId);
            var update = Builders<Bookmarks.Mongo.Data.TagBundle>.Update
                .Set(t => t.ExcludeTagBundles, excludeTagBundles)
                .CurrentDate("lastModified");
